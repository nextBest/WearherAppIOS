...
protocol WeatherRepository {
    func searchLocationByCoordinates(latitude: Double, longitude: Double, success: @escaping (WeatherData) -> Void, fail: @escaping (AFError) -> Void)
    func getWeatherInfo(woeid: Int, success: @escaping (WeatherData) -> Void, fail: @escaping (AFError) -> Void)
}
